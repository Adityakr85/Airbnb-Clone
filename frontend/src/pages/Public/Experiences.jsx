...
export default function Experiences() {
  ...
  const filteredExperiences = useMemo(() => {
    return experienceData.filter((exp) => {
      ...
      return (
        !searchQuery || loc.includes(searchQuery) || title.includes(searchQuery)
      );
    });
      ...
      {experienceData.length === 0 ? (
        ...
        filteredExperiences.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center py-32 text-gray-800">
            ...
            <p className="text-gray-500">
              Try changing your search destination.
            </p>
            <a
              href="/experiences"
              className="mt-6 rounded-lg border border-black px-6 py-3 font-semibold transition hover:bg-gray-50"
            >
              Clear Search
            </a>
          </div>
